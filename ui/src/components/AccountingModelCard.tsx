...
export function AccountingModelCard() {
  return (
    <Card className="relative overflow-hidden border-border/70">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,color-mix(in oklab, var(--destructive) 8%, transparent),transparent_35%),radial-gradient(circle_at_bottom_right,color-mix(in oklab, var(--status-info) 10%, transparent),transparent_32%)]" />
