...
const AgentRunCard = memo(function AgentRunCard({
  ...
  return (
    <div className={cn(
      ...
      isActive
        ? "border-status-info/25 bg-status-info/[0.04] shadow-[0_16px_40px_color-mix(in oklab, var(--status-info) 8%, transparent)]"
            ...
            <div className="flex items-center gap-2">
              {isActive ? (
                <span className="relative flex h-2.5 w-2.5 shrink-0">
                  <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-status-info opacity-70" />
          ...
          <div className="mt-3 rounded-lg border border-border/60 bg-background/60 px-2.5 py-2 text-xs">
            <Link
              ...
              className={cn(
                ...
                isActive ? "text-status-info dark:text-status-info" : "text-muted-foreground hover:text-foreground",
              )}
