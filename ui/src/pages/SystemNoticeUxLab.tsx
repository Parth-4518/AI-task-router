...
function LabSection({
  ...
  return (
    <section
      id={id}
      className={cn(
        "rounded-[28px] border border-border/70 bg-background/85 p-4 shadow-[0_24px_60px_var(--shadow-tint)] sm:p-5",
        accentClassName,
      )}
    >
...
export function SystemNoticeUxLab() {
  ...
  return (
    <div className="space-y-6">
      <div className="overflow-hidden rounded-[32px] border border-border/70 bg-[linear-gradient(135deg,rgba(245,158,11,0.10),transparent_28%),linear-gradient(180deg,rgba(8,145,178,0.08),transparent_44%),var(--background)] shadow-[0_30px_80px_var(--shadow-tint-strong)]">
